...
export class ConfigurationService {
  ...
  public static readonly defaultSignalRServerTimeout: number = 6; //in minutes
  public static readonly defaultSignalRKeepAliveInterval: number = 3; //in minutes
  //***End of defaults***  
  ...
  public menu: Menu;
  constructor(private localStorage: LocalStoreManager, private translationService: AppTranslationService, private http: HttpClient) {
