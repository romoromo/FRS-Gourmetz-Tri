...
export class Utilities {
  ...
  public static printTimeOnly(date: Date, is24Hr?: boolean) {
    ...
    let timeString = is24Hr ? hourString + ":" + minute : (hour + ":" + minute + " " + period);
  ...
  public static toDateOnly(d: Date) {
  ...
  public static getUniqueValues(arr, key): any[] {
