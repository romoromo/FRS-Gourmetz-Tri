...
export class DishSelectorMealAllocationComponent implements OnInit {
  ...
  constructor(private http: HttpClient, private dishService: DishService,
    private alertService: AlertService, public dialogRef: MatDialogRef<DishSelectorMealAllocationComponent>,
