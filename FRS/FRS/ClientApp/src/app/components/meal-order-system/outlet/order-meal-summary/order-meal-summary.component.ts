...
@Component({
  selector: 'order-meal-summary',
  templateUrl: './order-meal-summary.component.html',
  styleUrls: ['./order-meal-summary.component.css']
})
export class OrderMealSummaryComponent implements OnInit {
  stores: StoreInfo[];
  ...
  constructor(private http: HttpClient, private alertService: AlertService, private deliveryService: DeliveryService, public dialog: MatDialog,
    public dialogRef: MatDialogRef<OrderMealSummaryComponent>,private menuService: MenuService,
