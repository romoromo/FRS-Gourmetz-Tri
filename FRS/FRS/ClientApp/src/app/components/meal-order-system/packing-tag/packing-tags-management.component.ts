...
import { PackingTagEditorComponent } from './packing-tag-editor.component';
...
@Component({
  selector: 'packing-tags-management',
  templateUrl: './packing-tags-management.component.html',
  styleUrls: ['./packing-tags-management.component.css']
})
export class PackingTagsManagementComponent implements OnInit {
  columns: any[] = [];
  ...
  packingAllocationEditorComponent: PackingTagEditorComponent;
  header: string;
  ...
  openDialog(allocation: PackingAllocation): void {
    const dialogRef = this.dialog.open(PackingTagEditorComponent, {
