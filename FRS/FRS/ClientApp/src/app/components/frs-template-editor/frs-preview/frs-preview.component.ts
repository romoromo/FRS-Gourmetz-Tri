...
@Component({
  selector: 'frs-template-editor-preview',
  templateUrl: './frs-preview.component.html',
  styleUrls: ['./frs-preview.component.css'],
})
export class FRSTemplateEditorPreviewDialog implements OnInit, AfterViewInit {
  ...
  constructor(
    public dialogRef: MatDialogRef<FRSTemplateEditorPreviewDialog>,
