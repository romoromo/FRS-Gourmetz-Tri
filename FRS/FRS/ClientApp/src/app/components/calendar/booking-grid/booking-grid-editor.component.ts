...
@Component({
  selector: 'booking-grid-editor',
  templateUrl: './booking-grid-editor.component.html',
  styleUrls: ['./booking-grid-editor.component.css']
})
export class BookingGridEditorComponent implements OnInit {
