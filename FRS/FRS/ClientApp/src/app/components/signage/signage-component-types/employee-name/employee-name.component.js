        ...
        if (this.mac_address) {
            this.deviceService.getDeviceById(null, this.mac_address, true)
                ...
                if (_this.device) {
                    ...
                    _this.signalRCoreconnection = _this.authService.signalRConnection(_this.configurationService.baseUrl + "/hub/employeeschedule?location_id=" + _this.device.locationId, true, _this.signalRCoreconnection);
