...
export class ReservationEditorComponent {
  ...
  constructor(private alertService: AlertService, private accountService: AccountService, private reservationService: ReservationService, private authService: AuthService) {
  }
  ...
  newReservation(allLocations: Location[]) {
    ...
    this.reservationEdit.institutionId = this.authService.currentUser.institutionId;
