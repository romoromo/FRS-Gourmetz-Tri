...
} from "./components/calendar/calendar-booking-grid/day-view-scheduler.component";
...
import {
  QueueTableMapSimulator,
  QueueTableMapsManagementComponent,
} from "./components/queue-table-map/queue-table-maps-management.component";
...
import {
  MultiQueue,
  NgInit,
} from "./components/signage/signage-component-types/multi-queue/multi-queue.component";
...
} from "./components/controls/asset/assets-management.component";
...
} from "./components/meal-order-system/student/students-management.component";
...
import {
  ...
  NewMultipleBentoAsset,
} from "./components/meal-order-system/bento-asset/bento-assets-management.component";
...
import {
  CartonAssetsManagementComponent,
  CartonAssetQrCodeComponent,
} from "./components/meal-order-system/carton-asset/carton-assets-management.component";
...
import {
  StudentOrderManagementComponent,
...
import { StudentWalletTransferComponent } from "./components/meal-order-system/student/student-wallet-transfer/student-wallet-transfer.component";
...
import { InvoiceDetailComponent } from "./components/meal-order-system/wallet-transaction-log/invoice-detail.components";
...
@NgModule({
  ...
  declarations: [
    AppComponent,
    NoNavigationAppComponent,
    RootAppComponent,
    TemplateEditorComponent,
    TemplateEditorPreviewDialog,
    TemplateSaveDialogPreviewDialog,
    PIBDisplayComponent,
    FRSTemplateEditorComponent,
    FRSTemplateEditorPreviewDialog,
    FRSTemplateSaveDialogPreviewDialog,
    LoginComponent,
    ...
    DeviceForApprovalComponent,
    DashboardAvailableRoomComponent,
    PIBDeviceStatusListComponent,
    MeetingRoomDisplayComponent,
    ReservationListComponent,
    ReservationListEditorComponent,
    CalendarComponent,
    CalendarHeaderComponent,
    DayViewSchedulerComponent,
    CalendarLandingPageComponent,
    BookingComponent,
    BookingEditorComponent,
    BookingGridComponent,
    BookingGridEditorComponent,
    CalendarBookingGridComponent,
    CalendarBookingGridEditorComponent,
    SettingsComponent,
    ...
    FacilityTypesManagementComponent,
    FacilityTypeEditorComponent,
    SignageComponentsManagementComponent,
    SignageComponentEditorComponent,
    SignageCompilationsManagementComponent,
    SignageCompilationEditorComponent,
    SignagePublicationsManagementComponent,
    SignagePublicationEditorComponent,
    DeviceManagerComponent,
    DeviceEditorComponent,
    DevicesManagementComponent,
    LocationEditorComponent,
    LocationsManagementComponent,
    LocationTreeEditorComponent,
    LocationsTreeManagementComponent,
    InstitutionsManagementComponent,
    InstitutionEditorComponent,
    DepartmentsManagementComponent,
    DepartmentEditorComponent,
    ContactGroupsManagementComponent,
    ContactGroupEditorComponent,
    CGNewContactEmailEditorComponent,
    FileUploadComponent,
    ImageUploadComponent,
    ContactGroupSelectorComponent,
    UserSelectorComponent,
    UserPhonebookEditorComponent,
    UserPhonebooksManagementComponent,
    UserPhonebookSelectorComponent,
    AssetSelectorComponent,
    ReportsReservationListComponent,
    PIBDevicesManagementComponent,
    PIBDeviceEditorComponent,
    PIBDeviceManagerComponent,
    ...
    EpaperDevicesManagementComponent,
    EpaperDeviceEditorComponent,
    EpaperDeviceManagerComponent,
    UserVehicleEditorComponent,
    UserCardIdEditorComponent,
    UserVehiclesManagementComponent,
    SignageComponentTypeWrapperComponent,
    VjsPlayerComponent,
    FreeHTMLConfiguration,
    FreeHTML,
    DeviceDisplayWarningComponent,
    ReportContainerComponent,
    KioskSettingsListComponent,
    KioskSettingsEditComponent,
    VideoConfiguration,
    Video,
    SignagePlaylistConfiguration,
    SignagePlaylist,
    ClockConfiguration,
    Clock,
    ...
    TextConfiguration,
    TextDisplay,
    ApplicationSettingEditorComponent,
    ...
    EmployeeDesignationsManagementComponent,
    EmployeeScheduleEditorComponent,
    EmployeeScheduleAssignComponent,
    EmployeeSchedulesManagementComponent,
    EmployeeDataEditorComponent,
    EmployeeDatasManagementComponent,
    QueueTableMapEditorComponent,
    QueueTableMapsManagementComponent,
    QueueTableMapSimulator,
    NewMultipleBentoAsset,
    CreateAccountMultiple,
    OccupancyLogEditorComponent,
    OccupancyLogsManagementComponent,
    DirectoryListingEditorComponent,
    DirectoryListingsManagementComponent,
    BuildingEditorComponent,
    BuildingsManagementComponent,
    FloorEditorComponent,
    FloorsManagementComponent,
    MapEditorComponent,
    MapsManagementComponent,
    MediasManagementComponent,
    ...
    WayfinderComponent,
    WayfinderLandscapeComponent,
    EmsProfilesComponent,
    EmsProfileEditorComponent,
    SignageDashboardContainerComponent,
    UserGroupsManagementComponent,
    UserGroupEditorComponent,
    EmsSchedulesComponent,
    EmsScheduleEditorComponent,
    EmsesManagementComponent,
    EmsEditorComponent,
    ...
    AuthLogsManagementComponent,
    UpDownTimeLogsManagementComponent,
    DataLogsManagementComponent,
    DataLogViewerComponent,
    ImageReferenceTypesManagementComponent,
    ImageReferenceTypeEditorComponent,
    ImageReferenceColorsManagementComponent,
    ImageReferenceColorEditorComponent,
    SmartRoomSchedulerLogsManagementComponent,
    SmartRoomSchedulerDetailsViewerComponent,
    AssetTypesManagementComponent,
    AssetTypeEditorComponent,
    AssetModelsManagementComponent,
    AssetModelEditorComponent,
    AssetsManagementComponent,
    AssetEditorComponent,
    AssetQrCodeComponent,
    ServiceContractsManagementComponent,
    ServiceContractEditorComponent,
    EmailQueuesManagementComponent,
    DeviceTypesManagementComponent,
    DeviceTypeEditorComponent,
    ChannelInfosManagementComponent,
    ChannelInfoEditorComponent,
    StudentsManagementComponent,
    StudentEditorComponent,
    StudentGroupsManagementComponent,
    StudentGroupEditorComponent,
    StudentSelectorComponent,
    ScanTagComponent,
    ClassBatchesManagementComponent,
    ClassBatchEditorComponent,
    ClassLevelsManagementComponent,
    ClassLevelEditorComponent,
    DispenserOutletManagementComponent,
    DispenserOutletEditorComponent,
    ClassesManagementComponent,
    ClassEditorComponent,
    ClassTransferComponent,
    StaffTypesManagementComponent,
    StaffTypeEditorComponent,
    StaffsManagementComponent,
    StaffEditorComponent,
    RestrictionTypesManagementComponent,
    RestrictionTypeEditorComponent,
    RestrictionsManagementComponent,
    RestrictionEditorComponent,
    DishTypeEditorComponent,
    DishTypesManagementComponent,
    CuisineEditorComponent,
    CuisinesManagementComponent,
    CatererInfoEditorComponent,
    CatererInfosManagementComponent,
    ...
    PackingProcesssManagementComponent,
    DoProcesssManagementComponent,
    CartonAssetEditorComponent,
    CartonAssetsManagementComponent,
    BentoUsageManagementComponent,
    CartonAssetQrCodeComponent,
    BentoBoxTypeEditorComponent,
    BentoBoxTypesManagementComponent,
    CartonTypeEditorComponent,
    CartonTypesManagementComponent,
    DeliveryOrderEditorComponent,
    DeliveryOrdersManagementComponent,
    DeliveryOrderNewEditorComponent,
    DeliveryOrdersNewManagementComponent,
    TrackingStatusEditorComponent,
    TrackingStatussManagementComponent,
    StoreInfoEditorComponent,
    StoreInfosManagementComponent,
    MealTypeEditorComponent,
    MealTypesManagementComponent,
    MealPeriodEditorComponent,
    MealPeriodsManagementComponent,
    DishEditorComponent,
    DishesManagementComponent,
    DishSelectorComponent,
    DishPreviewComponent,
    DishPreviewErrorComponent,
    TokenOrderEditorComponent,
    TokenOrderBulkEditorComponent,
    TokenOrdersBulkManagementComponent,
    MenuEditorComponent,
    MenusManagementComponent,
    TokenOrdersManagementComponent,
    MenuCycleEditorComponent,
    MenuCyclesManagementComponent,
    MealAllocationssManagementComponent,
    PrintAllocationComponent,
    CatererSelectorComponent,
    CatererApprovalComponent,
    DOSelectorComponent,
    ReceiveDOComponent,
    InventorySelectorComponent,
    InventoryDetailComponent,
    StoreSelectorComponent,
    StoreSelectorDetailsComponent,
    DriverEditorComponent,
    DriversManagementComponent,
    RouteEditorComponent,
    RoutesManagementComponent,
    OrderReportComponent,
    OrderMealSummaryComponent,
    PrintLabelComponent,
    PackingAllocationssManagementComponent,
    PackingAllocationEditorComponent,
    InterestGroupEditorComponent,
    InterestGroupsManagementComponent,
    MealSessionEditorComponent,
    OrderDeliveryReportComponent,
    PackingTagsManagementComponent,
    PackingTagEditorComponent,
    MenuCycleCalendarComponent,
    ViewMenuCycleMenuComponent,
    OutletMenuCycleCalendarComponent,
    OutletViewMenuCycleMenuComponent,
    OutletClassRosterEditorComponent,
    MenuDishSelectorEditorComponent,
    OutletClassRostersManagementComponent,
    StudentMenuCycleCalendarComponent,
    TokenOrderPaymentComponent,
    TokenOrderPaymentThankyouComponent,
    DishCycleEditorComponent,
    DishCyclesManagementComponent,
    DishCycleCalendarComponent,
    ViewDishCycleMenuComponent,
    OutletDishCycleCalendarComponent,
    OutletViewDishCycleMenuComponent,
    PaymentTypesManagementComponent,
    PaymentTypeEditorComponent,
    TransactionFeesManagementComponent,
    TransactionFeeEditorComponent,
    VoucherTypesManagementComponent,
    VoucherTypeEditorComponent,
    VouchersManagementComponent,
    VouchersUnassignManagementComponent,
    VoucherEditorComponent,
    VoucherDishComponent,
    WalletTransactionLogManagementComponent,
    WaiversManagementComponent,
    WaiverEditorComponent,
    ContactUsDetailsManagementComponent,
    ContactUsDetailEditorComponent,
    ContactUsSubjectEditorComponent,
    ContactUsSubjectsManagementComponent,
    EmailTemplatesManagementComponent,
    EmailTemplateEditorComponent,
    InterestGroupEmailComponent,
    NotificationEventEditorComponent,
    NotificationEventsManagementComponent,
    ...
    MenuGroupEditorComponent,
    MenuGroupsManagementComponent,
    OrderCancellationsManagementComponent,
    UserRolesReportManagementComponent,
    OrderCancellationReportManagementComponent,
    NotificationSettingComponent,
    MealPlanSummaryComponent,
    MultiFactorLoginComponent,
    OrderPortalContentEditorComponent,
    OrderPortalContentsManagementComponent,
    StudentGroupOrderSummaryComponent,
    UserActivityLogsManagementComponent,
    UserActivityLogViewerComponent,
    OutletTermsManagementComponent,
    OutletTermEditorComponent,
    StudentOrderManagementComponent,
    StatusDropdownComponent,
    StudentOrderDetailComponent,
    MatStatusDropdownComponent,
    StudentEditorComponent,
    StudentOrderEditorComponent,
    DefaultPipe,
    ...
    StudentWalletTopupComponent,StudentPointTopupComponent,StudentWalletTransferComponent,
    ...
    DetailedBasicWalletTopUpReport
  ],
  providers: [
