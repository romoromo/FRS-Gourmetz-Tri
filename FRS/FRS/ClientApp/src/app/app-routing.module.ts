...
const routes: Routes = [
  ...
  //Site routes goes here 
  {
    ...
    children: [
      ...
      { path: "point-transaction-log-management", component: PointTransactionLogManagementComponent, canActivate: [AuthGuard], data: { title: "Point Transactions" } },
      ...
      { path: "assetcomponent", component: AssetComponentManagementComponent, canActivate: [AuthGuard], data: {title: "Asset Components"}}
