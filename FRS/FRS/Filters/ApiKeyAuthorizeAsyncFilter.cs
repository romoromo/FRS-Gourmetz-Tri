...
namespace FRS.Filters
{
    public class ApiKeyAuthorizeAsyncFilter : IAsyncAuthorizationFilter
    {
        ...
        private readonly IApiKeyManager _apiKeyService;

        public ApiKeyAuthorizeAsyncFilter(ILogger<ApiKeyAuthorizeAsyncFilter> logger, IApiKeyManager apiKeyService)
        {
            _logger = logger;
