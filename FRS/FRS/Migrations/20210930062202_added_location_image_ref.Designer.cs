...
namespace FRS.Migrations
{
    ...
    [Migration("20210930062202_added_location_image_ref")]
    partial class added_location_image_ref
    {
            ...
            modelBuilder.Entity("DAL.Models.Device", b =>
                {
                    ...
                    b.HasIndex("InstitutionId", "Code", "IsActive")
                        .IsUnique()
                        .HasFilter("[InstitutionId] IS NOT NULL AND [Code] IS NOT NULL");
