...
namespace BAL.Services.Interfaces
{
    public interface IEmailSender
    {
        ...
        Task<(bool success, string errorMsg)> SendEmailOldAsync(MailboxAddress sender, MailboxAddress[] recepients, string subject, string body, SmtpConfig config = null, bool isHtml = true, List<EmailAttachment> attachments = null);
        ...
        Task<(bool success, string errorMsg)> SendEmailOauthAsync(string recepientName, string recepientEmail, string subject, string body, SmtpOauth2Config config = null, bool isHtml = true, List<EmailAttachment> attachments = null, string action = null);
        Task<(bool success, string errorMsg)> SendEmailOauthAsync(string senderName, string senderEmail, string recepientName, string recepientEmail, string subject, string body, SmtpOauth2Config config = null, bool isHtml = true, List<EmailAttachment> attachments = null);
