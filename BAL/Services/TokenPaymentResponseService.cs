...
namespace BAL.Services
{
    public class TokenPaymentResponseService: ITokenPaymentService
    {
        ...
        public TokenPaymentResponseService(IUnitOfWork uow, ISieveProcessor sieveProcessor)
        {
        ...
        public async Task<BaseOperationResponse> CreateTokenPaymentRequestAsync(TokenPaymentRequestDTO dto)
        {
            ...
            result     = await this._uow.SubmittedPayments.CreateAsync(Mapper.Map<TokenPaymentRequest>(dto));
            return result;
        }

        public async Task<TokenPaymentResponseDTO> GetByIdAsync(string id)
        {
             return Mapper.Map<TokenPaymentResponseDTO>(await this._uow.ProcessedPayments.FindAsync(e => e.PaymentTransactionId == id));
        }
        ...
        {
            var result = new BaseOperationResponse();
            result     = await this._uow.ProcessedPayments.UpdateAsync(Mapper.Map<TokenPaymentUpdate>(dto));
