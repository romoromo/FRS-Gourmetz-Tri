        ...
        public async Task<byte[]> GeneratePrintDo(int doId)
        {
            ...
            if (dOrder != null)
            {
                using (var stream = new System.IO.MemoryStream())
                {
                    ...
                    float[] widths = new float[] { 3f, 7.5f, 2f, 3.5f };
                    ...
                    PdfPCell cell = new PdfPCell(png) { Colspan = 2 };
                    cell.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    table2.AddCell(cell);

                    PdfPCell cell2 = new PdfPCell(new Phrase("Company", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD))) { Rowspan = 2 };
                    cell2.HorizontalAlignment = PdfPCell.ALIGN_CENTER;
                    table2.AddCell(cell2);

                    table2.AddCell(getCell("SATS FOOD SERVICE PTE LTD", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell("GST Regn: ", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell("M90363671C ", PdfPCell.ALIGN_CENTER));

                    table2.AddCell(getCell("234 Pandan Loop, Singapore 128422", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell("UEN NO: ", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell("197300678G ", PdfPCell.ALIGN_CENTER));

                    table2.AddCell(getCell("From : ", PdfPCell.ALIGN_CENTER));
                    ...
                    table2.AddCell(getCell("To Location :   ", PdfPCell.ALIGN_CENTER));
                    ...
                    table2.AddCell(getCell("Address :   ", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell(dOrder.ToStoreAddress, PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell("Route : ", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell(dOrder.RouteName, PdfPCell.ALIGN_CENTER));

                    table2.AddCell(getCell("Meal Period :   ", PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell(dOrder.MealSessionName, PdfPCell.ALIGN_CENTER));
                    table2.AddCell(getCell("Pickup Time : ", PdfPCell.ALIGN_CENTER));
                    if (dOrder.PickupTime != null)
                    {
                        table2.AddCell(getCell(dOrder.PickupTime.Value.ToString("HH:mm"), PdfPCell.ALIGN_CENTER));
                    } else
                    {
                    ...
                    PdfPCell cell_1_h = new PdfPCell(new Phrase("Carton No", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
                    PdfPCell cell_2_h = new PdfPCell(new Phrase("Item Description", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
                    PdfPCell cell_3_h = new PdfPCell(new Phrase("Categories", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
                    PdfPCell cell_4_h = new PdfPCell(new Phrase("QTY", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
                    ...
                    dOrder.DeliveryDetails.ForEach(c => {
                        PdfPCell cell_1 = new PdfPCell(new Phrase(c.CartonAssetCode, new Font(Font.FontFamily.HELVETICA, 12,Font.BOLD)));
                        PdfPCell cell_2 = new PdfPCell(new Phrase(""));
                        PdfPCell cell_3 = new PdfPCell(new Phrase("", new Font(Font.FontFamily.HELVETICA, 12, Font.BOLD)));
                        ...
                        DOReports.ForEach(dd => {
                            PdfPCell i_cell_1 = new PdfPCell(new Phrase(dd.dishCode));
                            PdfPCell i_cell_2 = new PdfPCell(new Phrase(dd.dishLabel));
                            PdfPCell i_cell_4 = new PdfPCell(new Phrase(dd.categories));
                            PdfPCell i_cell_3 = new PdfPCell(new Phrase(dd.dishQty + ""));
                    ...
                    table.AddCell(emptyCell);
                    table.AddCell(emptyCell);
                    PdfPCell t_cell_1 = new PdfPCell(new Phrase("Total Meals: "));
                    PdfPCell t_cell_2 = new PdfPCell(new Phrase(totalQty + ""));

                    t_cell_1.HorizontalAlignment = Element.ALIGN_CENTER;
                    ...
                    float[] widths2 = new float[] { 3f, 7.5f};
                    table3.SetWidths(widths2);
                    table3.WidthPercentage = 65f;

                    table3.AddCell(getCell("Received By : ", PdfPCell.ALIGN_CENTER));
                    table3.AddCell(getCell(" ", PdfPCell.ALIGN_CENTER));
                    table3.AddCell(getCell("Date : ", PdfPCell.ALIGN_CENTER));
                    table3.AddCell(getCell(" ", PdfPCell.ALIGN_CENTER));
                    table3.AddCell(getCell("Time : ", PdfPCell.ALIGN_CENTER));
                    table3.AddCell(getCell(" ", PdfPCell.ALIGN_CENTER));
