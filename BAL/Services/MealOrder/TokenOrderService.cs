    ...
    public class TokenOrderService : ITokenOrderService
    {
                        ...
                        if (a.MealSessionDetail != null)
                        {
                            ...
                            if (alr == null)
                            {
                                ...
                                foreach (var tl in a.tokens)
                                {
                                    ...
                                    if (tl.order_id.HasValue && tl.order_id != 0 && tl.Order.IsFAS)
                                    {
        ...
        public async Task<BaseOperationResponse> ApprovalCancelOrderRequestAsync(CancelOrderRequestDTO dto)
        {
            ...
            if (isApproved && result.IsSuccess && result.Data != null)
            {
                ...
                TokenOrder to = await this._uow.TokenOrders.GetByIdAsync(dto.OrderId);
        ...
        public async Task<BaseOperationResponse> DirectCancelOrderAsync(DirectCancelOrderDTO dto)
        {
            ...
            if (result.IsSuccess && result.Data != null)
            {
                ...
                TokenOrder order = await this._uow.TokenOrders.GetByIdAsync(dto.OrderId);
