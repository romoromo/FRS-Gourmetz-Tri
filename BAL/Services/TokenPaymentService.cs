...
namespace BAL.Services
{
    public class TokenPaymentService: ITokenPaymentService
    {
        ...
        public TokenPaymentService(IUnitOfWork uow, ISieveProcessor sieveProcessor)
        {
        ...
        //{
        //    return Mapper.Map<TokenPaymentResponseDTO>(await this._uow.SubmittedPayments.GetTokenPaymentByIdAsync(id));
        //}
