...
namespace BAL.Services
{
    public class TokenPaymentService: ITokenPaymentService
    {
        ...
        public TokenPaymentService(IUnitOfWork uow, ISieveProcessor sieveProcessor, IMapper mapper)
        {
        ...
        //public async Task<TokenPaymentResponseDTO> GetByIdAsync(int id)
        //{
        //    return _mapper.Map<TokenPaymentResponseDTO>(await this._uow.SubmittedPayments.GetTokenPaymentByIdAsync(id));
        //}
