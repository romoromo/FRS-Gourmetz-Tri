...
namespace BAL.Services
{
    public class EmailQueueService : IEmailQueueService
    {
        ...
        public EmailQueueService(IUnitOfWork uow, ISieveProcessor sieveProcessor)
        {
        ...
        {
            var result = Mapper.Map<PagedEntity<EmailQueueDTO>>(await this._uow.EmailQueues.GetEmailQueuesAsync(filter));
            return result;
        }

        public async Task<EmailQueueDTO> GetEmailQueueByIdAsync(int id)
        {
            return Mapper.Map<EmailQueueDTO>(await this._uow.EmailQueues.GetByIdAsync(id));
        }

        public async Task<BaseOperationResponse> CreateEmailQueueAsync(EmailQueueDTO dto)
        {
            var result = new BaseOperationResponse();
            result = await this._uow.EmailQueues.CreateAsync(Mapper.Map<EmailQueue>(dto));
            return result;
        }
        ...
        {
            var result = new BaseOperationResponse();
            result = await this._uow.EmailQueues.UpdateAsync(Mapper.Map<EmailQueue>(dto));
            return result;
        }
        ...
        {
            var result = Mapper.Map<PagedEntity<ContactUsSubjectDTO>>(await this._uow.ContactUsSubjects.GetContactUsSubjectsAsync(filter));
            return result;
        }

        public async Task<ContactUsSubjectDTO> GetContactUsSubjectByIdAsync(int id)
        {
            return Mapper.Map<ContactUsSubjectDTO>(await this._uow.ContactUsSubjects.GetByIdAsync(id));
        }

        public async Task<BaseOperationResponse> CreateContactUsSubjectAsync(ContactUsSubjectDTO dto)
        {
            var result = new BaseOperationResponse();
            result = await this._uow.ContactUsSubjects.CreateAsync(Mapper.Map<ContactUsSubject>(dto));
            return result;
        }
        ...
        {
            var result = new BaseOperationResponse();
            result = await this._uow.ContactUsSubjects.UpdateAsync(Mapper.Map<ContactUsSubject>(dto));
            return result;
        }
        ...
        {
            var result = Mapper.Map<PagedEntity<ContactUsDetailDTO>>(await this._uow.ContactUsDetails.GetContactUsDetailsAsync(filter));
            return result;
        }

        public async Task<ContactUsDetailDTO> GetContactUsDetailByIdAsync(int id)
        {
            return Mapper.Map<ContactUsDetailDTO>(await this._uow.ContactUsDetails.GetByIdAsync(id));
        }

        public async Task<BaseOperationResponse> CreateContactUsDetailAsync(ContactUsDetailDTO dto)
        {
            var result = new BaseOperationResponse();
            result = await this._uow.ContactUsDetails.CreateAsync(Mapper.Map<ContactUsDetail>(dto));
            return result;
        }
        ...
        {
            var result = new BaseOperationResponse();
            result = await this._uow.ContactUsDetails.UpdateAsync(Mapper.Map<ContactUsDetail>(dto));
            return result;
        }
        ...
        {
            var result = Mapper.Map<PagedEntity<EmailTemplateDTO>>(await this._uow.EmailTemplates.GetEmailTemplatesAsync(filter));
            return result;
        }

        public async Task<EmailTemplateDTO> GetEmailTemplateByIdAsync(int id)
        {
            return Mapper.Map<EmailTemplateDTO>(await this._uow.EmailTemplates.GetByIdAsync(id));
        }

        public async Task<BaseOperationResponse> CreateEmailTemplateAsync(EmailTemplateDTO dto)
        {
            var result = new BaseOperationResponse();
            result = await this._uow.EmailTemplates.CreateAsync(Mapper.Map<EmailTemplate>(dto));
            return result;
        }
        ...
        {
            var result = new BaseOperationResponse();
            result = await this._uow.EmailTemplates.UpdateAsync(Mapper.Map<EmailTemplate>(dto));
            return result;
        }
