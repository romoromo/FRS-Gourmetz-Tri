    ...
    public class EntityToDTOAutoMapperProfile : Profile
    {
        public EntityToDTOAutoMapperProfile()
        {
            ...
            CreateMap<StudentWalletTransaction, StudentWalletTransactionDTO>()
                .ForMember(e => e.TransactionDateTime, map => map.MapFrom(e => e.CreatedDate))
                .ForMember(e => e.UserId, map => map.MapFrom(e => e.CreatedBy))
        ...
        private void MapMealOrderEntityProfile()
        {
            ...
            CreateMap<Dish, DishDTO>()
                ...
                .ForMember(e => e.CuisineName, map => map.MapFrom(f => f.Cuisine.Name))
                .ForMember(e => e.CuisineLicenseCode, map => map.MapFrom(f => f.Cuisine.LicenseCode))
                .ForMember(e => e.CuisineIconFileName, map => map.MapFrom(f => f.Cuisine.Icon.FileName))
                .ForMember(e => e.CuisineIconFilePath, map => map.MapFrom(f => f.Cuisine.Icon.Path))
